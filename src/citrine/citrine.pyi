...
def wavelength_temperature_tuning(lambda_p: Wavelength, lambda_s: Wavelength, lambda_i: Wavelength, poling_period: float, crystal: Crystal, temp_range: tuple, num_points: int = 50) -> tuple: ...
